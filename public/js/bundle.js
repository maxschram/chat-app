...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chat = __webpack_require__(158);
	var root = document.getElementById('content');
	
	ReactDOM.render(React.createElement(Chat, null), root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Message = __webpack_require__(166);
	var socket = io();
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'ul',
	        { id: 'messages', style: { overflow: 'auto', paddingBottom: '40px' } },
	        this.state.messages.map(function (message) {
	          return React.createElement(Message, _extends({}, message, { key: message.id }));
	        })
	      ),
	      React.createElement(
	        'form',
	        {
	          action: '' },
	        React.createElement('input', { autoComplete: 'off', valueLink: this.linkState('message') }),
	        React.createElement(
	          'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  scroll: function scroll(li) {
	    li.scrollIntoView();
	  },
	  render: function render() {
	    return React.createElement(
	      'li',
	      { key: this.props.id, ref: this.scroll },
	      this.props.body
	    );
	  }
	});
